...
class FilterViewController: UIViewController, UITableViewDelegate ,UITableViewDataSource, RangeSeekSliderDelegate , UITextFieldDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        arrFilterOptions = ["PRICE", "PRODUCTS", "BRAND", "VENDOR"]
    ...
    @IBAction func btnApply(_ sender: Any)
    {
        ...
        dicFilter.setValue(strType, forKey: "type")
        dicFilter.setValue(strBrand, forKey: "brand")
        dicFilter.setValue(strVendorId, forKey: "vandor")
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "ApplyFilter"), object: dicFilter)
    ...
    @IBAction func btnReset(_ sender: Any)
    {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "RemoveFilter"), object: nil)
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int
    {
        if arrFilterOptionSelected.contains(section)
        {
            ...
            {
                return arrType.count + 1
            }
            else if section == 2
            {
                return arrBrand.count + 1
            }
            else if section == 3
            {
                return arrVendor.count + 1
            }
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    cell?.lblOption.text = (arrType.object(at: indexPath.row - 1) as! NSDictionary).valueForNullableKey(key: "name")
                    
                    if strType == (arrType.object(at: indexPath.row - 1) as! NSDictionary).valueForNullableKey(key: "name") {
                ...
                {
                    cell?.lblOption.text = (arrBrand.object(at: indexPath.row - 1) as! NSDictionary).valueForNullableKey(key: "name")
                    
                    if strBrand == (arrBrand.object(at: indexPath.row - 1) as! NSDictionary).valueForNullableKey(key: "name") {
                ...
                else
                {
                    ...
                    let dicVendor = arrVendor.object(at: indexPath.row - 1) as! NSDictionary
                    
                    
                    let strName = String(format: "%@ %@", dicVendor.valueForNullableKey(key: "firstName"),dicVendor.valueForNullableKey(key: "lastName"))
                    
                    
                    cell?.lblOption.text = strName
                    
                    if strVendorId == dicVendor.valueForNullableKey(key: "id")
                    {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        else
        {
            if indexPath.section == 1
            {
                strType = (arrType.object(at: indexPath.row - 1) as! NSDictionary).valueForNullableKey(key: "name")
            }
            else if indexPath.section == 2
            {
               strBrand =  (arrBrand.object(at: indexPath.row - 1) as! NSDictionary).valueForNullableKey(key: "name")
            }
            else if indexPath.section == 3
            {
                ...
                strVendorId = dicVendor.valueForNullableKey(key: "id")
            }
