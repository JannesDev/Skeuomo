...
@IBDesignable open class RangeSeekSlider: UIControl {
    ...
    private func updateColors() {
        ...
        if let initialColor = initialColor?.cgColor, isInitial {
            ...
            sliderLineBetweenHandles.backgroundColor =  UIColor(red: 16/255.0, green: 135/255.0, blue: 254/255.0, alpha: 1.0).cgColor
            
            sliderLine.backgroundColor =  UIColor(red: 16/255.0, green: 135/255.0, blue: 254/255.0, alpha: 1.0).cgColor
            ...
            leftHandle.borderColor = UIColor(red: 16/255.0, green: 135/255.0, blue: 254/255.0, alpha: 1.0).cgColor
            leftHandle.borderWidth = 0.50
            rightHandle.backgroundColor = UIColor.white.cgColor
            rightHandle.borderColor =  UIColor(red: 16/255.0, green: 135/255.0, blue: 254/255.0, alpha: 1.0).cgColor
            rightHandle.borderWidth = 0.50
        }
    }
